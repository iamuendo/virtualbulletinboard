@section("title","View Events | TaarifaBoard")

<x-app-layout>

    <x-slot name="header">
        <div class="border-b border-gray-200 pb-10">
            <h1 class="flex-1 text-lg font-medium tracking-tight text-blue-900">{{ __('View Events') }}</h1>
        </div>
    </x-slot>
                    ...
                    <div class="sm:flex">
                        <div class="sm:w-1/2">
                            <div class="aspect-w-3 aspect-h-3 bg-gray-200 group-hover:opacity-75 sm:aspect-none sm:h-85">
                                <img src="https://research.zetech.ac.ke/images/modules/conference.png" alt="Event Image">
                            </div>
                        </div>
                        <div class="sm:w-1/2 p-4 space-y-2 flex flex-col justify-between">
                            ...
                            <p class="text-sm text-gray-500">Get a chance to explore various innovative enterprises and student projects.</p>
                            <div class="flex flex-col justify-end">
                                <dl class="mt-2 flex flex-col text-gray-500">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <dd><time datetime="2024-03-10T17:00">July 27th, 2023</time></dd>
                                    </div>
