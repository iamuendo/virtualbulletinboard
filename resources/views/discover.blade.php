                            ...
                            <form class="divide-y divide-gray-200 space-y-10">
                                ...
                                <div class="pt-10">
                                    <fieldset>
                                        ...
                                        <div class="pt-6 space-y-3">
                                            <div class="flex items-center">
                                                <input id="charges-1" name="charges[]" value="all" type="checkbox" class="h-4 w-4 border-gray-300 rounded text-blue-600 focus:ring-blue-500">
                                                <label for="charges-1" class="ml-3 text-sm text-gray-600">
                                                    All
                                                </label>
                                            </div>

                                            <div class="flex items-center">
                                                <input id="charges-2" name="charges[]" value="free" type="checkbox" class="h-4 w-4 border-gray-300 rounded text-blue-600 focus:ring-blue-500">
                                                <label for="charges-2" class="ml-3 text-sm text-gray-600">
                                                    Free
                                                </label>
                                            </div>

                                            <div class="flex items-center">
                                                <input id="charges-3" name="charges[]" value="paid" type="checkbox" class="h-4 w-4 border-gray-300 rounded text-blue-600 focus:ring-blue-500">
                                                <label for="charges-3" class="ml-3 text-sm text-gray-600">
                                                    Paid
                                                </label>
                                            </div>
                                        </div>
